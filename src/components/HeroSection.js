  ...
  return (
    <div className="hero_section flex justify-evenly items-center my-16 gap-20 relative text-white">
      ...
      <div className="hero_left flex flex-col justify-center gap-8">
        ...
        <div 
          className="btn bg-red-500 text-white py-2 px-4 rounded text-sm w-[100px] cursor-pointer" 
      ...
      <div className="hero_right w-[250px] h-[250px] relative animate-bounce">
        ...
        <img src={circle} alt='circle' className='absolute bottom-[-10px] animate-bounce' />
